...
def goal_track(img,bbox):
    ...
    #Activity 2 - Uncomment the correct code 
    cv2.circle(img,(c1,c2),2,(223,149,249),5)

    cv2.circle(img,(int(p1),int(p2)),2,(223,149,249),3)
...
while True:
    ...
    #Activity 3 - call the function to track the goal
    goal_track(img, bbox)
